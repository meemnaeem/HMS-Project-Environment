...
<head>
    ...
    <!--[if lt IE 9]>
   <script src="doccure/admin/assets/js/html5shiv.min.js"></script>
   <script src="doccure/admin/assets/js/respond.min.js"></script>
  <![endif]-->
</head>
            ...
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <img class="img-fluid" src="doccure/admin/assets/img/logo-white.png" alt="Logo">
                    </div>
