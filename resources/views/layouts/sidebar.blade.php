        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{ request()->is('admin/review*') ? 'active' : '' }}">
                    <a href="{{ route('admin.review.index') }}"><i class="fe fe-star-o"></i> <span>Reviews</span></a>
                </li>
                <li class="{{ request()->is('admin/transaction*') ? 'active' : '' }}">
                    <a href="{{ route('admin.transaction.index') }}"><i class="fe fe-activity"></i>
                        <span>Transactions</span></a>
                </li>
                <li class="{{ request()->is('admin/setting*') ? 'active' : '' }}">
                    <a href="{{ route('admin.setting.index') }}"><i class="fe fe-vector"></i> <span>Settings</span></a>
                </li>
                <li class="submenu">
                    <a href="#"><i class="fe fe-document"></i> <span> Reports</span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li class="{{ request()->is('admin/invoice-report*') ? 'active' : '' }}"><a
                                href="{{ route('admin.invoice-report.index') }}">Invoice Reports</a></li>
                    </ul>
                </li>
                <li class="menu-title">
                    <span>Pages</span>
                ...
                <li class="{{ request()->is('admin/profile*') ? 'active' : '' }}">
                    <a href="{{ route('admin.profile.index') }}"><i class="fe fe-user-plus"></i>
                        <span>Profile</span></a>
                </li>
                <li class="submenu">
